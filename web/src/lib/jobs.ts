...
export const jobOptionsSchema = z.object({
  ...
  // finer Z gradient. UI range 0.01–0.30 mm: 0.01 is fiber-pitch dense,
  // 0.15 is the balanced default, 0.30 is a draft.
  layer_height_mm: z.number().min(0.01).max(0.30).default(0.15),
